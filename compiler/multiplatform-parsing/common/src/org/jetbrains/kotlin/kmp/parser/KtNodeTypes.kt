...
object KtNodeTypes : SyntaxElementTypesWithIds() {
    ...
    const val REFINEMENT_TYPE_ID: Int = TYPE_PROJECTION_ID + 1
    const val FUNCTION_TYPE_RECEIVER_ID: Int = REFINEMENT_TYPE_ID + 1
    ...
    val REFINEMENT_TYPE: SyntaxElementType = register(REFINEMENT_TYPE_ID, "REFINEMENT_TYPE")
